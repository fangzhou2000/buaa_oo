...
public interface Network {
    ...
    /*@ public normal_behavior
      ...
      @ ensures getMessage(id).getPerson1().getSocialValue() ==
      @         \old(getMessage(id).getPerson1().getSocialValue()) + getMessage(id).getSocialValue() &&
      @         getMessage(id).getPerson2().getSocialValue() ==
      @         \old(getMessage(id).getPerson2().getSocialValue()) + getMessage(id).getSocialValue();
      ...
      @          getMessage(id).getPerson2().getMessages()[i+1] == \old(getMessage(id).getPerson2().getMessages()[i]));
      @ ensures getMessage(id).getPerson2().getMessages()[0] == getMessage(id);
      @ ensures getMessage(id).getPerson2().getMessages().length = \old(getMessage(id).getPerson2().getMessages().length) + 1;
      @ also
      @ public normal_behavior
