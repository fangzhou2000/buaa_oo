...
public class UmlRule004Exception extends PreCheckRuleException {
    private final Set<? extends UmlClass> classes;
     ...
     */
    public UmlRule004Exception(Set<? extends UmlClass> classes) {
        super(String.format(
                "Failed when check R004, class (%s) have duplicate realizations.",
                classes.stream()
