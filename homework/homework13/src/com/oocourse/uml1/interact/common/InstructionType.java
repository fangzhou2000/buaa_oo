...
public enum InstructionType {
    ...
    public static final Map<InstructionType, InputArgumentParser> INSTRUCTION_PARSERS
        ...
        put(CLASS_ATTR_COUNT, InputArgumentParser.newInstance(InstructionType.class, String.class));
        ...
        put(CLASS_ATTR_TYPE, InputArgumentParser.newInstance(InstructionType.class, String.class, String.class));
        put(CLASS_OPERATION_PARAM_TYPE, InputArgumentParser.newInstance(InstructionType.class, String.class, String.class));
